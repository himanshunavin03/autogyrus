...
$cfg['blowfish_secret']					= 'Gr.\":X|V?RVX6GX9QoZJ]]A7kDzlI$Rd' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_JvizBPgxwMOek1NAL8qWu0I/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'http://autogyrus.local/wp-admin/?rand=43626996&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'http://autogyrus.local/wp-admin/?rand=38502598&pma_logout=1';
